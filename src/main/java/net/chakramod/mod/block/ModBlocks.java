...
public class ModBlocks {
    ...
    public static final Block GREEN_MINERAL_CRACKED_STONE_BRICKS = registerBlock("green_mineral_cracked_stone_bricks", new Block(FabricBlockSettings.of(Material.STONE).strength(5.0F).requiresTool()));
    ...
    public static final Block GREEN_MINERAL_SMOOTH_STONE = registerBlock("green_mineral_smooth_stone", new WallBlock(FabricBlockSettings.of(Material.STONE).strength(5.0F).requiresTool()));
